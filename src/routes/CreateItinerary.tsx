...
import { Bus, CalendarIcon, ChevronDownIcon, ChevronLeft, Plane, Train } from 'lucide-react';
    ...
    <>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="flex space-x-4">
            <Link to="..">
              <Button variant="outline"><ChevronLeft/>Cancel</Button>
            </Link>
            <Button type="submit" disabled={loading}>Update preferences</Button>
          </div>
        </form>
      </Form>
    </>
